  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-white overflow-x-hidden selection:bg-[#39d353]/30 selection:text-[#39d353]">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-grid-pattern opacity-[0.03] animate-grid pointer-events-none" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#0d1117] via-transparent to-[#050505] pointer-events-none" />
      ...
      {/* Terminal Demo - Responsive & Interactive */}
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        <div className="absolute inset-x-0 bottom-0 h-[500px] bg-gradient-to-t from-[#238636]/10 to-transparent pointer-events-none" />
